...
(function ($) {
  ...
  function Antiscroll (el, opts) {
    ...
    this.inner = this.el.find('.x-scroll-body');
    this.inner.css({
        'width': '+=' + scrollbarSize()
  ...
  Scrollbar.prototype.show = function (duration) {
    if (!this.shown) {
      this.update();
      this.el.addClass('x-scroll-bar-show');
      if (this.hiding) {
  ...
  Scrollbar.prototype.hide = function () {
    if (this.shown) {
      // check for dragging
      this.el.removeClass('x-scroll-bar-show');
      this.shown = false;
    }
  };
  ...
  Scrollbar.Horizontal = function (pane) {
    this.el = $('<div class="x-scroll-bar x-scroll-bar-h">');
  ...
  Scrollbar.Vertical = function (pane) {
    this.el = $('<div class="x-scroll-bar x-scroll-bar-v">');
    Scrollbar.call(this, pane);
  };
...
bui.define('foo.container.container', {
...
bui.define('foo.container.viewport', {
  
  extend: 'foo.container.container'
  
});})(window,window.document,window.eval);